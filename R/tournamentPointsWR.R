...
#'
#' @export
#' @rdname tournamentPointsWR
#'
tournamentPointsWR=function(WR,level=5,pow=c(3,3,3,3,1,1),w=c(32,32,31,28,10,6),bronze=TRUE,A=1000){
	...
	cbind(Rank=Rank,WR=p,PointsWR,PointsBonus,Points)
	}
